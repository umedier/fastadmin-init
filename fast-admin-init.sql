/*
 ...
 Source Host           : localhost:15030
 Source Schema         : fast-admin-init

 Target Server Type    : MariaDB
 Target Server Version : 100415
 File Encoding         : 65001

 Date: 20/01/2022 18:30:31
*/
...
-- Records of fa_admin
-- ----------------------------
INSERT INTO `fa_admin` VALUES (1, 'ysq', 'Admin', '9977c478fd27ff04cd21ac18dd58bdb2', 'e19abb', 'http://192.168.8.128:18000/assets/img/avatar.png', 'admin@admin.com', 0, 1642672649, '192.168.8.128', 1491635035, 1642672649, 'bbe6de13-7be9-4174-9a5b-3fc503f163d8', 'normal');
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '管理员日志表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of fa_admin_log
-- ----------------------------
INSERT INTO `fa_admin_log` VALUES (1, 1, 'ysq', '/yZcQuiFkzd.php/index/login', '登录', '{\"__token__\":\"***\",\"username\":\"ysq\",\"password\":\"***\",\"captcha\":\"Xghe\"}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642672649);
INSERT INTO `fa_admin_log` VALUES (2, 1, 'ysq', '/yZcQuiFkzd.php/addon/install', '插件管理', '{\"name\":\"bootstrapcontextmenu\",\"force\":\"0\",\"uid\":\"35384\",\"token\":\"***\",\"version\":\"1.0.1\",\"faversion\":\"1.3.2.20220113\"}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642672822);
INSERT INTO `fa_admin_log` VALUES (3, 1, 'ysq', '/yZcQuiFkzd.php/addon/state', '插件管理 / 禁用启用', '{\"name\":\"bootstrapcontextmenu\",\"action\":\"enable\",\"force\":\"0\"}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642672823);
INSERT INTO `fa_admin_log` VALUES (4, 1, 'ysq', '/yZcQuiFkzd.php/addon/install', '插件管理', '{\"name\":\"crontab\",\"force\":\"0\",\"uid\":\"35384\",\"token\":\"***\",\"version\":\"1.0.6\",\"faversion\":\"1.3.2.20220113\"}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642672859);
INSERT INTO `fa_admin_log` VALUES (5, 1, 'ysq', '/yZcQuiFkzd.php/addon/state', '插件管理 / 禁用启用', '{\"name\":\"crontab\",\"action\":\"enable\",\"force\":\"0\"}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642672859);
INSERT INTO `fa_admin_log` VALUES (6, 1, 'ysq', '/yZcQuiFkzd.php/addon/install', '插件管理', '{\"name\":\"log\",\"force\":\"0\",\"uid\":\"35384\",\"token\":\"***\",\"version\":\"1.0.4\",\"faversion\":\"1.3.2.20220113\"}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642672887);
INSERT INTO `fa_admin_log` VALUES (7, 1, 'ysq', '/yZcQuiFkzd.php/addon/state', '插件管理 / 禁用启用', '{\"name\":\"log\",\"action\":\"enable\",\"force\":\"0\"}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642672888);
INSERT INTO `fa_admin_log` VALUES (8, 1, 'ysq', '/yZcQuiFkzd.php/addon/config?name=log&dialog=1', '插件管理 / 配置', '{\"name\":\"log\",\"dialog\":\"1\",\"row\":{\"level\":[\"log\",\"error\",\"notice\",\"info\",\"debug\",\"sql\"]}}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642672903);
INSERT INTO `fa_admin_log` VALUES (9, 1, 'ysq', '/yZcQuiFkzd.php/auth/rule/multi', '权限管理 / 菜单规则', '{\"action\":\"\",\"ids\":\"1\",\"params\":\"ismenu=0\"}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642674522);
INSERT INTO `fa_admin_log` VALUES (10, 1, 'ysq', '/yZcQuiFkzd.php/auth/rule/multi', '权限管理 / 菜单规则', '{\"action\":\"\",\"ids\":\"3\",\"params\":\"ismenu=0\"}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642674526);
INSERT INTO `fa_admin_log` VALUES (11, 1, 'ysq', '/yZcQuiFkzd.php/auth/rule/multi', '权限管理 / 菜单规则', '{\"action\":\"\",\"ids\":\"66\",\"params\":\"ismenu=0\"}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642674532);
INSERT INTO `fa_admin_log` VALUES (12, 1, 'ysq', '/yZcQuiFkzd.php/auth/rule/multi', '权限管理 / 菜单规则', '{\"action\":\"\",\"ids\":\"4\",\"params\":\"ismenu=0\"}', '192.168.8.128', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36', 1642674556);
...
) ENGINE = InnoDB AUTO_INCREMENT = 95 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '节点表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of fa_auth_rule
-- ----------------------------
INSERT INTO `fa_auth_rule` VALUES (1, 'file', 0, 'dashboard', 'Dashboard', 'fa fa-dashboard', '', '', 'Dashboard tips', 0, NULL, '', 'kzt', 'kongzhitai', 1491635035, 1642674522, 143, 'normal');
...
INSERT INTO `fa_auth_rule` VALUES (3, 'file', 0, 'category', 'Category', 'fa fa-leaf', '', '', 'Category tips', 0, NULL, '', 'flgl', 'fenleiguanli', 1491635035, 1642674526, 119, 'normal');
INSERT INTO `fa_auth_rule` VALUES (4, 'file', 0, 'addon', 'Addon', 'fa fa-rocket', '', '', 'Addon tips', 0, NULL, '', 'cjgl', 'chajianguanli', 1491635035, 1642674556, 0, 'normal');
...
INSERT INTO `fa_auth_rule` VALUES (66, 'file', 0, 'user', 'User', 'fa fa-user-circle', '', '', '', 0, NULL, '', 'hygl', 'huiyuanguanli', 1491635035, 1642674532, 0, 'normal');
...
INSERT INTO `fa_auth_rule` VALUES (85, 'file', 2, 'general/crontab', '定时任务', 'fa fa-tasks', '', '', '类似于Linux的Crontab定时任务,可以按照设定的时间进行任务的执行,目前支持三种任务:请求URL、执行SQL、执行Shell', 1, NULL, '', 'dsrw', 'dingshirenwu', 1642672859, 1642672859, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (86, 'file', 85, 'general/crontab/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1642672859, 1642672859, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (87, 'file', 85, 'general/crontab/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1642672859, 1642672859, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (88, 'file', 85, 'general/crontab/edit', '编辑 ', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1642672859, 1642672859, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (89, 'file', 85, 'general/crontab/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1642672859, 1642672859, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (90, 'file', 85, 'general/crontab/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1642672859, 1642672859, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (91, 'file', 2, 'general/logs', '日志管理', 'fa fa-pied-piper-alt', '', '', '', 1, NULL, '', 'rzgl', 'rizhiguanli', 1642672887, 1642672887, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (92, 'file', 91, 'general/logs/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1642672887, 1642672887, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (93, 'file', 91, 'general/logs/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1642672887, 1642672887, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (94, 'file', 91, 'general/logs/detail', '详情', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'xq', 'xiangqing', 1642672887, 1642672887, 0, 'normal');
...
CREATE TABLE `fa_config`  (
  ...
  `value` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '变量值',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '变量字典数据',
...
CREATE TABLE `fa_crontab`  (
  ...
  `createtime` int(10) NULL DEFAULT NULL COMMENT '创建时间',
  `updatetime` int(10) NULL DEFAULT NULL COMMENT '更新时间',
  `begintime` int(10) NULL DEFAULT NULL COMMENT '开始时间',
  `endtime` int(10) NULL DEFAULT NULL COMMENT '结束时间',
  `executetime` int(10) NULL DEFAULT NULL COMMENT '最后执行时间',
  `weigh` int(10) NOT NULL DEFAULT 0 COMMENT '权重',
...
CREATE TABLE `fa_crontab_log`  (
  ...
  `executetime` int(10) NULL DEFAULT NULL COMMENT '执行时间',
  `completetime` int(10) NULL DEFAULT NULL COMMENT '结束时间',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '执行结果',
...
-- Records of fa_user
-- ----------------------------
INSERT INTO `fa_user` VALUES (1, 1, 'admin', 'admin', '0cf0bdcbd4719a1471274d86a485c8a1', '2e59db', 'admin@163.com', '13888888888', 'http://192.168.8.128:18000/assets/img/avatar.png', 0, 0, '2017-04-08', '', 0.00, 0, 1, 1, 1491635035, 1491635035, '127.0.0.1', 0, '127.0.0.1', 1491635035, 0, 1491635035, '', 'normal', '');
...
CREATE TABLE `fa_user_group`  (
  ...
  `rules` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '权限节点',
